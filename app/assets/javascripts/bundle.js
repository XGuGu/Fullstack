...
/******/ 	return __webpack_require__(__webpack_require__.s = "./frontend/pindup.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
var signup = function signup(user) {
  return function (dispatch) {
    _util_session_api_util__WEBPACK_IMPORTED_MODULE_0__["signup"](user).then(function (serverUser) {
...
var login = function login(user) {
  return function (dispatch) {
    _util_session_api_util__WEBPACK_IMPORTED_MODULE_0__["login"](user).then(function (serverUser) {
      return dispatch(receiveCurrentUser(serverUser));
    }, function (err) {
      return dispatch(receiveErrors(err.responseJSON));
    });
...
var logout = function logout() {
  return function (dispatch) {
    _util_session_api_util__WEBPACK_IMPORTED_MODULE_0__["logout"]().then(function (user) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "welcome"), root); // ReactDOM.render(<Root store={store}/>, root);
});
